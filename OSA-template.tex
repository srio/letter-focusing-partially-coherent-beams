...
a)\\
\hspace{-2.0cm}
    \includegraphics[width=0.775\textwidth]{sizes_h-eps-converted-to.pdf}\\
b)\\
\hspace{-2.0cm}
    \includegraphics[width=0.775\textwidth]{sizes_v-eps-converted-to.pdf}
...
Data and code underlying the results presented in this paper are publicly available at \url{https://github.com/srio/paper-transfocators-resources}
